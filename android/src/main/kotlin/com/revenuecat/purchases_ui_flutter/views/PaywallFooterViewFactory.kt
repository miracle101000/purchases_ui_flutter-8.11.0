...
private const val TAG = "RC_PaywallFooterFactory"
        ...
        val resolvedActivity =
                activity()
                        ?: run {
                            Log.e(
                                    TAG,
                                    "create(viewId=$viewId): activity is null — cannot create PaywallFooterView"
                            )
                            error(
                                    "PaywallFooterViewFactory requires an Activity context, but none is currently attached. " +
